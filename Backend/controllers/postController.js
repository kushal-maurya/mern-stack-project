...
const createPost = async ( req, res ) => {
    try {
        ...
        if(text.lenght > maxLength) {
            return res.status(400).json({ message: `Text must be less ${maxLength} characters` });
        }
...
const getPost = async ( req, res ) => {
    try {
        ...
        res.status(400).json({ message: err.message});
        console.log("Error in loading Post: ", err.message);
    }
}
...
const replyToPost = async (req, res ) => {
    try {
        ...
        res.status(400).json({ message: err.message});
        console.log("Error in reply post: ", err.message);
    }
}
...
const getFeedPosts = async( req, res ) => {
    try {
        ...
        console.log("Error in Feeding the post: ", err.message);
    }
}
